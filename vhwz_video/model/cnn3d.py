# source https://github.com/jfzhang95/pytorch-video-recognition/blob/master/network/R3D_model.py
...
class R3D(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        num_classes = int(cfg.dataset.train.nb_sample)
        layer_sizes = (2, 2, 2, 2)
...
if __name__ == "__main__":
    ...
    cfg = Cfg()
    cfg.dataset = Cfg()
    cfg.dataset.nb_sample = 64
    inputs = torch.rand(1, 3, cfg.dataset.nb_sample, 112, 112)
    net = R3D(cfg)
