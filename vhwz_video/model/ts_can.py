...
@MODEL.register('TSCAN')
class TSCAN(nn.Module):

    def __init__(self, cfg, in_channels=3, nb_filters1=32, nb_filters2=64, kernel_size=3, dropout_rate1=0.25,
    ...
    def forward(self, diff_input, raw_input, params=None):
        '''inputs: 
        frames: N, C, T, H, W => N, T, C, H, W => N*T, C, H, W
        bvps(label): N, T => N*T
        '''
        # diff_input = inputs[:, :3, :, :]
        # raw_input = inputs[:, 3:, :, :]
